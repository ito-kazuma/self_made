...
<body>
    ...
    <div class="table-responsive">
      <table class="table table-striped text-nowrap">
        <thead>
          <tr>
            <th>名前</th><th>フリガナ</th><th>電話番号</th><th>メール</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td><?php echo $rows['name']?></td>
            <td><?php echo $rows['furigana']?></td>
      ...
      <a href="information.php?info=<?= $_POST['event_id'] ?>"><button class="btn btn-danger btn-md">戻る</button></a>
